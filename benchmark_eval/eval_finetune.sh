...
#SBATCH -o /leonardo/home/userexternal/amehrish/HyperAlign/benchmark_eval/logs/fteval_%j.out
#SBATCH -e /leonardo/home/userexternal/amehrish/HyperAlign/benchmark_eval/logs/fteval_%j.out
#
...
FTDIR=$W/workdir/finetune_${BENCH}/ckpt
